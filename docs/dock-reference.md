...
| `IProportionalDockSplitter` | Thin splitter placed between proportional docks. Exposes `CanResize` and `ResizePreview` to control dragging. When previewing the splitter is highlighted. |
