...
using DockInpcSample.Models.Documents;
using DockInpcSample.Models.Tools;
using DockInpcSample.ViewModels.Docks;
using DockInpcSample.ViewModels.Documents;
using DockInpcSample.ViewModels.Tools;
using DockInpcSample.ViewModels.Views;

namespace DockInpcSample.ViewModels;
