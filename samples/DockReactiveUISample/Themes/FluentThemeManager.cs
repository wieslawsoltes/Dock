...
{
    private static readonly Uri BaseUri = new("avares://DockReactiveUISample/Styles");
    ...
    private static readonly Styles FluentDark = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://DockReactiveUISample/Themes/FluentDark.axaml")
        }
    };
    ...
    private static readonly Styles FluentLight = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://DockReactiveUISample/Themes/FluentLight.axaml")
        }
    };
