...
public class DockFluentTheme : Styles, IResourceNode
{
    ...
    /// </summary>
    public static readonly DirectProperty<DockFluentTheme, DockDensityStyle> DensityStyleProperty =
        AvaloniaProperty.RegisterDirect<DockFluentTheme, DockDensityStyle>(
            nameof(DensityStyle),
            o => o.DensityStyle,
