...
public class FlatProportionalDockSplitter : Thumb
{
    ...
    public static readonly StyledProperty<double> ThicknessProperty =
        AvaloniaProperty.Register<FlatProportionalDockSplitter, double>(nameof(Thickness), 4.0);

    /// <summary>
    /// Defines the <see cref="IsResizingEnabled"/> property.
    /// </summary>
    public static readonly StyledProperty<bool> IsResizingEnabledProperty =
        AvaloniaProperty.Register<FlatProportionalDockSplitter, bool>(nameof(IsResizingEnabled), true);

    /// <summary>
    /// Defines the <see cref="PreviewResize"/> property.
    /// </summary>
    public static readonly StyledProperty<bool> PreviewResizeProperty =
        AvaloniaProperty.Register<FlatProportionalDockSplitter, bool>(nameof(PreviewResize));

    /// <summary>
    /// Defines the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly StyledProperty<AvaloniaOrientation> OrientationProperty =
        AvaloniaProperty.Register<FlatProportionalDockSplitter, AvaloniaOrientation>(nameof(Orientation));
    ...
    /// </summary>
    public IProportionalDockSplitter? Splitter { get; internal set; }

    /// <summary>
    /// Gets the proportional dock that owns <see cref="Splitter"/>.
    /// </summary>
    public IProportionalDock? OwnerDock { get; internal set; }
    ...
    {
        return Orientation == AvaloniaOrientation.Vertical
    ...
    protected override void OnPointerPressed(PointerPressedEventArgs e)
    {
        ...
        _startOffset = Orientation == AvaloniaOrientation.Vertical ? position.Value.Y : position.Value.X;
    ...
    protected override void OnPointerMoved(PointerEventArgs e)
    {
        ...
        var axisDelta = Orientation == AvaloniaOrientation.Vertical ? delta.Y : delta.X;
    ...
    protected override void OnPointerReleased(PointerReleasedEventArgs e)
    {
        ...
        if (_isMoving && IsResizingEnabled && GetPanel() is { } panel && PreviewResize)
        {
            var point = e.GetPosition(panel);
            var delta = point - _startPoint;
            panel.ResizeSplitter(this, Orientation == AvaloniaOrientation.Vertical ? delta.Y : delta.X);
        }
    ...
    private FlatProportionalDockPanel? GetPanel()
    {
        return this.FindAncestorOfType<FlatProportionalDockPanel>();
    }

    private void UpdateVisualState()
    {
        if (Orientation == AvaloniaOrientation.Vertical)
        {
            Height = Thickness;
            Width = double.NaN;
