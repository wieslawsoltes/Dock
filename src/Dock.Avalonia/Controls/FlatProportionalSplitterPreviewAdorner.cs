...
internal sealed class FlatProportionalSplitterPreviewAdorner : Control
{
    public static readonly StyledProperty<AvaloniaOrientation> OrientationProperty =
        AvaloniaProperty.Register<FlatProportionalSplitterPreviewAdorner, AvaloniaOrientation>(nameof(Orientation));
    ...
    public override void Render(DrawingContext context)
    {
        ...
        var rect = Orientation == AvaloniaOrientation.Vertical
