...
public class OverlayDock : DockBase, IOverlayDock
{
    ...
    public bool AllowPanelDragging
    {
        ...
        set => Set(ref _allowPanelDragging, value);
    }
    ...
    public bool AllowPanelResizing
    {
        ...
        set => Set(ref _allowPanelResizing, value);
    }
    ...
    public bool EnableSnapToEdge
    {
        ...
        set => Set(ref _enableSnapToEdge, value);
    }
    ...
    {
        get => _snapThreshold;
        set => Set(ref _snapThreshold, value);
    }
    ...
    public bool EnableSnapToPanel
    {
        ...
        set => Set(ref _enableSnapToPanel, value);
    }
    ...
    public double DefaultPanelOpacity
    {
        ...
        set => Set(ref _defaultPanelOpacity, value);
    }
    ...
    public bool EnableBackdropBlur
    {
        ...
        set => Set(ref _enableBackdropBlur, value);
    }
    ...
    public bool ShowAlignmentGrid
    {
        ...
        set => Set(ref _showAlignmentGrid, value);
    }
    ...
    public double AlignmentGridSize
    {
        ...
        set => Set(ref _alignmentGridSize, value);
    }
    ...
    {
        NotifyOfPropertyChange(nameof(OverlayPanels));
        NotifyOfPropertyChange(nameof(BackgroundDockable));
    }
}
