...
public class DocumentDock : DockBase, IDocumentDock, IDocumentDockFactory
{
    ...
    public DocumentDock()
    {
        ...
        CascadeDocuments = new DelegateCommand(CascadeDocumentsExecute);
        TileDocumentsHorizontal = new DelegateCommand(TileDocumentsHorizontalExecute);
        TileDocumentsVertical = new DelegateCommand(TileDocumentsVerticalExecute);
        RestoreDocuments = new DelegateCommand(RestoreDocumentsExecute);
    }
