...
public class ProportionalDockSplitter : DockableBase, IProportionalDockSplitter
{
    ...
    public ProportionalDockSplitter()
    {
        ...
        ResetProportionCommand = new DelegateCommand(() => _adapter.ResetProportion(this));
        SetProportionCommand = new DelegateCommand<double?>(p => _adapter.SetProportion(this, p ?? 0), _ => true);
    }
