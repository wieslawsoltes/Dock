...
public partial class OverlayDock : DockBase, IOverlayDock
{
    ...
    public IList<IOverlaySplitterGroup>? SplitterGroups
    {
        ...
        set
        {
            this.RaiseAndSetIfChanged(ref _splitterGroups, value);
            if (Factory is { } factory)
            {
    ...
    public bool AllowPanelDragging
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _allowPanelDragging, value);
    }
    ...
    public bool AllowPanelResizing
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _allowPanelResizing, value);
    }
    ...
    public bool EnableSnapToEdge
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _enableSnapToEdge, value);
    }
    ...
    {
        get => _snapThreshold;
        set => this.RaiseAndSetIfChanged(ref _snapThreshold, value);
    }
    ...
    public bool EnableSnapToPanel
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _enableSnapToPanel, value);
    }
    ...
    public double DefaultPanelOpacity
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _defaultPanelOpacity, value);
    }
    ...
    public bool EnableBackdropBlur
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _enableBackdropBlur, value);
    }
    ...
    public bool ShowAlignmentGrid
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _showAlignmentGrid, value);
    }
    ...
    public double AlignmentGridSize
    {
        ...
        set => this.RaiseAndSetIfChanged(ref _alignmentGridSize, value);
    }
    ...
    {
        this.RaisePropertyChanged(nameof(OverlayPanels));
        this.RaisePropertyChanged(nameof(BackgroundDockable));
    }
}
