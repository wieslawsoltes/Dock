...
public interface IDock : IDockable
{
    ...
    /// <summary>
    /// Gets or sets optional per-dock capability policy values.
    /// Null values inherit root policy and dockable base flag values.
    /// </summary>
    DockCapabilityPolicy? DockCapabilityPolicy { get; set; }
