...
public static class DockSettings
{
    ...
    /// <summary>
    /// Sets the default owner mode for floating windows when <see cref="Dock.Model.Core.IDockWindow.OwnerMode"/> is <see cref="Dock.Model.Core.DockWindowOwnerMode.Default"/>.
    /// </summary>
